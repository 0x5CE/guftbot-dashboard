    ...
    <div>
      ...
      <Flex mt={20}>
        ...
        >
          ...
          <Link
            href="https://slack.com/oauth/v2/authorize?client_id=2964626451557.3813425087350&amp;scope=channels:join,chat:write,im:history,channels:history,channels:manage,channels:read,groups:read,im:write,users:read.email,users:read&amp;user_scope=identity.basic"
            passHref
          >
            <a>
              <Image
